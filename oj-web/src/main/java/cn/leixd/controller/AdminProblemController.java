...
//            String path = this.getClass().getResource("").getPath().split("onlinejudge-server")[0] + "problemData" + File.separator + dirName;
            String path = "/home/lxd/problemData"+ File.separator + dirName;
//            System.out.println(path);
            //getHttpServletRequest().getServletContext().getRealPath("/problem_cases")
            //将上面这个路径修改为固定路径
...
//
//        File testcase = new File(this.getClass().getResource("").getPath().split("onlinejudge-server")[0] +  "problemData" + File.separator + testCaseId);
        File testcase = new File("/home/lxd/problemData"+ File.separator + testCaseId);
        if (!testcase.exists()) {
            //文件不存在
...
//            testcase.renameTo(new File(this.getClass().getResource("").getPath().split("onlinejudge-server")[0] +  "problemData" + File.separator + pro.getProblem_id()));
            testcase.renameTo(new File("/home/lxd/problemData"+ File.separator + pro.getProblem_id()));
