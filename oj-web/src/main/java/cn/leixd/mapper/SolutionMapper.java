...
import cn.leixd.entity.po.Solution;
import cn.leixd.entity.po.User;
import cn.leixd.entity.vo.SolutionStatus;
...
public interface SolutionMapper {
     ...
     * @return
     */
    @Update("update solution set time=#{time},memory=#{memory},result=#{result},judgetime = #{judgetime} where solution_id = #{solution_id}")
    int updateSolutionBySolutionId(@Param("solution_id") String solution_id,
                                   @Param("time") Integer time,
                                   @Param("memory") Integer memory,
                                   @Param("result") Integer result,
                                   @Param("judgetime")Timestamp judgetime);
    /**
     * 插入源代码表
     *
     ...
     * @return
     */
    @Select("select source from source_code where solution_id = #{solution_id}")
    String getSourceCodeBySolutionId(@Param("solution_id") String solution_id);
    ...
    Solution getSolutionBySolutionId(@Param("solution_id")String solutionId);
