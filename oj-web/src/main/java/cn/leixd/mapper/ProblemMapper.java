...
import cn.leixd.entity.po.Problem;
...
public interface ProblemMapper {
     ...
     * @return
     */
    @Update("update problems set accepted = accepted+1 where problem_id = #{problem_id}")
    int addProblemOneAccepted(@Param("problem_id") Integer problem_id);
}
